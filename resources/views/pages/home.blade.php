...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ url('logo-kaur.png') }}" rel="icon">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <div class="">
                    <a href="index.html" class="navbar-brand p-0">
                        <img src="{{ url('logo-kaur.png') }}" alt="Logo">
                    </a>
                    <span style="font-size: 26px; color: #fff; font-family: 'Heebo', sans-serif">Desa Tebing Rambutan</span>
                </div>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">Sistem Informasi Kependudukan Desa Tebing Rambutan Kabupaten Kaur</h1>
                            <p class="text-white pb-3 animated zoomIn">Membantu dalam Pengelolaan Data Penduduk pada Desa Tebing Rambutan Kabupaten Kaur</p>
                            @if (!Auth::user())
