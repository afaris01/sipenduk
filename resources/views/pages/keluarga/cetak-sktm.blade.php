...
<body>
    <div class="container" style="padding-left: 50px; padding-right: 50px;">
        <div class="row justify-content-center text-center">
            <div class="col-3">
                <img src="{{ url('logo-kaur.png') }}" alt="" srcset="" style=" width: 110px; margin-left: -200px;">
            </div>
            <div class="col-9" style="margin-left: -200px;">
                <h4>PEMERINTAH Kabupaten Kaur</h4>
                <h3 class="font-weight-bold">KECAMATAN SINGARAN PATI</h3>
                <h3 class="font-weight-bold">Desa Tebing Rambutan</h3>
                <p style=" margin-top: 2px; font-size: 20px;">Jalan Merapi 7 RT.29 RW.02 Kabupaten Kaur</p>
            </div>
        </div>
        ...
        <p class="mt-4" style="text-indent: 60px;">Yang bertanda tangan dibawah ini Kepala Desa Tebing Rambutan Kecamatan Singaran Pati Kabupaten Kaur</p>
        ...
        <table class="table table-borderless" style="margin-top: -30px;">
            <tbody class="text-center ttd">
                <tr>
                    ...
                    <td style="width: 50%;">Kepala Desa Tebing Rambutan</td>
                </tr>
                <tr>
